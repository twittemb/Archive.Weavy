#
#  Be sure to run `pod spec lint Weavy.podspec' to ensure this is a
...
* Facilitate the cutting of an application into logical blocks of navigation
  ...
  # Or just: s.author    = "Thibault Wittemberg"
  ...
  s.source       = { :git => "https://github.com/twittemb/Weavy.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Weavy/**/*.{swift,h}"
  s.exclude_files = "WeavyDemo"
